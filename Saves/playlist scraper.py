#!/usr/bin/env python3
"""
YouTube Playlist Scraper — GUI edition.
...
Run:
    python playlist_scraper_gui.py

Playlists you add are remembered between runs (saved to
downloads/playlists.json), so you can just reopen the app and hit
Update on whichever ones you want to refresh.
"""
